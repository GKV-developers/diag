...
#### FFTW-SPACK (. /vol0001/apps/oss/spack/share/spack/setup-env.sh; spack load fftw) ###
#FFTW_DIR=`spack location -i fftw`
#INC = -I$(FFTW_DIR)/include
#LIB = -L$(FFTW_DIR)/lib -lfftw3 -lm -SSL2

### NetCDF (. /vol0001/apps/oss/spack/share/spack/setup-env.sh; spack load netcdf-fortran@4.5.2%fj) ###
NetCDF_DIR=`spack location -i netcdf-fortran@4.5.2%fj`
...
diag:	${SRC}/diag_header.f90\
	...
	${FC} ${FFLAGS} -c ${SRC}/out_netcdf.f90 ${INC} ${LIB}
